.PHONY: help setup install_vim_vundle install_vim_plugins create_symlinks remove_symlinks create_php_dict create_perl_dict

help:
	@echo "Please use \`make <target>' where <target> is one of"
	@echo "  setup               to setup initialize."
	@echo "  install_vim_vundle  to install vundle vim plugin."
...
setup: remove_symlinks install_vim_vundle create_symlinks

install_vim_vundle: 
	sh scripts/install_vim_vundle.sh
install_vim_plugins: 
